...
incompatible changes, especially since L<Riap::TCP> is new, so caveat
implementor.
...
If transport is used, host (and port) means network host (and port) as usual:
 ...
 riap+http://gudangapi.com/tax/id/validate_npwp
...
layout. Example:
 ...
 http://gudangapi.com/ga/tax.id.validate_npwp?npwp=123456
...
Server may add additional keys. Transport specification like L<Riap::TCP> or
L<Riap::HTTP> might require additional keys.
